...
public class Menus extends JFrame {
    ...
    private JMenuItem[] other = {
            //Adding a menu shortcut (mnemonic) is very simple, but only JMenuItems can have them in their constructors:
    ...
    //Then you don't have to figure out which one it is:
    ...
    class CMIL implements ItemListener {
        ...
        public void itemStateChanged(ItemEvent e) {
            ...
            if(actionCommand.equals("Guard")) {
                t.setText("Guard the Ice Cream! " +"Is it hidden? " + target.getState());
            }
        }
    }
    ...
    public static void main(String[] args) {
        SwingConsole.run(new Menus(), 800, 500);
    }
}
